<template>
    <div class="form-group">
        ...
        <p>
            ...
            <var style="color:red">AUD {{transferFee}}</var></p>
        <hr/>
        <p>
            <strong>TTL to be deducted:</strong>
            <var style="color:red">{{sendValue}}</var> +
            <var style="color:red">AUD {{transferFee}}</var> &equals;
